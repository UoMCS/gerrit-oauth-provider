...
class UoMGitLabOAuthService implements OAuthServiceProvider {
    ...
    @Inject
    UoMGitLabOAuthService(PluginConfigFactory cfgFactory,
    ...
    public OAuthUserInfo getUserInfo(OAuthToken token) throws IOException {
        ...
        JsonElement userJson = OutputFormat.JSON.newGson().fromJson(response.getBody(),
                                                                    JsonElement.class);
